...
public protocol MarkdownStyle {
  ...
  func codeBlockAttributes(
    _ attributes: inout [NSAttributedString.Key: Any], paragraphState: ParagraphState)

  /// Modifies the given attributes to style an HTML block.
  func htmlBlockAttributes(
    _ attributes: inout [NSAttributedString.Key: Any], paragraphState: ParagraphState)

  /// Modifies the given attributes to style a paragraph.
  func paragraphAttributes(
    _ attributes: inout [NSAttributedString.Key: Any], paragraphState: ParagraphState)

  /// Modifies the given attributes to style a heading.
  func headingAttributes(
    _ attributes: inout [NSAttributedString.Key: Any], level: Int, paragraphState: ParagraphState)
...
extension MarkdownStyle {
  public func documentAttributes(_: inout [NSAttributedString.Key: Any]) {
    // do nothing
  }

  public func blockQuoteAttributes(_ attributes: inout [NSAttributedString.Key: Any]) {
    guard let font = attributes[.font] as? Font else { return }
    attributes[.font] = font.italic()
  }

  public func codeBlockAttributes(
    _ attributes: inout [NSAttributedString.Key: Any], paragraphState: ParagraphState
  ) {
  ...
  public func htmlBlockAttributes(
    _ attributes: inout [NSAttributedString.Key: Any], paragraphState: ParagraphState
  ) {
    attributes[.paragraphStyle] = makeParagraphStyle(for: paragraphState)
  }

  public func paragraphAttributes(
    _ attributes: inout [NSAttributedString.Key: Any], paragraphState: ParagraphState
  ) {
    attributes[.paragraphStyle] = makeParagraphStyle(for: paragraphState)
  }
  ...
  public func codeAttributes(_ attributes: inout [NSAttributedString.Key: Any]) {
    guard let font = attributes[.font] as? Font else { return }
    attributes[.font] = makeCodeFont()?.addingSymbolicTraits(font.fontDescriptor.symbolicTraits)
  }

  public func emphasisAttributes(_ attributes: inout [NSAttributedString.Key: Any]) {
    guard let font = attributes[.font] as? Font else { return }
    attributes[.font] = font.italic()
  }

  public func strongAttributes(_ attributes: inout [NSAttributedString.Key: Any]) {
    guard let font = attributes[.font] as? Font else { return }
    attributes[.font] = font.bold()
  }

  public func linkAttributes(
    _ attributes: inout [NSAttributedString.Key: Any], url: String, title: String
  ) {
...
extension MarkdownStyle {
  ...
  public func makeHeadingFont(_ level: Int) -> Font? {
  ...
  public func makeParagraphStyle(
    ...
    if paragraphState.isHanging {
      ...
      paragraphStyle.tabStops = [
        NSTextTab(
          textAlignment: paragraphState.alignment, location: indent + indentSize, options: [:])
      ]
    } else {
