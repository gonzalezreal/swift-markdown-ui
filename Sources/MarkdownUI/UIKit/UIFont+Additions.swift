  ...
  extension UIFont {
    ...
    public static func system(
      size: CGFloat, weight: Weight = .regular, design: UIFontDescriptor.SystemDesign
    ) -> UIFont {
    ...
    public static func system(_ style: TextStyle) -> UIFont {
      .preferredFont(forTextStyle: style)
    }

    /// Create a system font with the given style and design.
    @available(watchOS 7.0, *)
    public static func system(_ style: TextStyle, design: UIFontDescriptor.SystemDesign) -> UIFont {
